...
(function () {
  ...
  var T = {
    rose: { n: '玫瑰', e: ['🌱', '🌿', '🌹'], sn: ['种子', '发芽', '开花'], g: [43200, 172800], xp: 30, lv: 1, ss: 0, m: '热烈的爱' },
    sunflower: { n: '向日葵', e: ['🌱', '🌿', '🌻'], sn: ['种子', '发芽', '开花'], g: [43200, 172800], xp: 40, lv: 2, ss: 2, m: '沉默的爱' },
    tulip: { n: '郁金香', e: ['🌱', '🌿', '🌷'], sn: ['种子', '发芽', '开花'], g: [43200, 172800], xp: 30, lv: 1, ss: 0, m: '永恒的祝福' },
    cactus: { n: '仙人掌', e: ['🌱', '🌵'], sn: ['小芽', '成形'], g: [172800], xp: 50, lv: 4, ss: 1, m: '坚韧，外刚内柔' },
    lavender: { n: '薰衣草', e: ['🌱', '🌿', '💐'], sn: ['种子', '发芽', '开花'], g: [21600, 86400], xp: 25, lv: 3, ss: 3, m: '等待爱情' },
    daisy: { n: '雏菊', e: ['🌱', '🌿', '🌼'], sn: ['种子', '发芽', '开花'], g: [21600, 86400], xp: 20, lv: 1, ss: 0, m: '纯真，深藏心底的爱' },
    sakura: { n: '樱花', e: ['🌱', '🌿', '🌸'], sn: ['种子', '发芽', '开花'], g: [21600, 86400], xp: 25, lv: 1, ss: 0, m: '一生幸福' },
    hibiscus: { n: '芙蓉', e: ['🌱', '🌿', '🌺'], sn: ['种子', '发芽', '开花'], g: [43200, 172800], xp: 35, lv: 1, ss: 1, m: '纤细之美' },
    lotus: { n: '荷花', e: ['🌱', '🌿', '🪷'], sn: ['种子', '发芽', '开花'], g: [86400, 172800], xp: 45, lv: 1, ss: 1, m: '清雅坚贞' },
    clover: { n: '幸运草', e: ['🌱', '🌿', '🍀'], sn: ['种子', '发芽', '成形'], g: [10800, 43200], xp: 15, lv: 1, ss: 2, m: '幸运与希望' },
    lily: { n: '百合', e: ['🌱', '🌿', '🌷'], sn: ['种子', '发芽', '开花'], g: [43200, 172800], xp: 35, lv: 1, ss: 0, m: '纯洁的爱' },
    peony: { n: '牡丹', e: ['🌱', '🌿', '🌺'], sn: ['种子', '发芽', '开花'], g: [86400, 172800], xp: 45, lv: 3, ss: 1, m: '富贵吉祥' },
    orchid: { n: '兰花', e: ['🌱', '🌿', '🎍'], sn: ['种子', '发芽', '开花'], g: [86400, 172800], xp: 55, lv: 4, ss: 2, m: '高洁典雅' },
    maple: { n: '枫叶', e: ['🌱', '🌿', '🍁'], sn: ['种子', '发芽', '开花'], g: [21600, 86400], xp: 25, lv: 2, ss: 3, m: '美好的回忆' },
    jasmine: { n: '茉莉', e: ['🌱', '🌿', '🌼'], sn: ['种子', '发芽', '开花'], g: [21600, 86400], xp: 20, lv: 2, ss: 1, m: '清新淡雅' },
    iris: { n: '鸢尾', e: ['🌱', '🌿', '💬'], sn: ['种子', '发芽', '开花'], g: [43200, 172800], xp: 30, lv: 3, ss: 0, m: '爱的使者' },
    bamboo: { n: '竹', e: ['🌱', '🌿', '🎋'], sn: ['笋', '发芽', '成竹'], g: [172800, 432000], xp: 60, lv: 4, ss: 0, m: '坚韧不拔' },
